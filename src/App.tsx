    ...
    <main className="min-h-screen bg-teal-800 text-slate-100 flex flex-col relative overflow-hidden py-2 px-4 sm:px-6 lg:px-7">
      ...
      <div className="w-full max-w-3xl mx-auto relative z-10 flex flex-col gap-5">
        ...
        <header className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-xs font-semibold tracking-wide uppercase shadow-inner">
            <Sparkles className="w-3.5 h-3.5" />
            <span>Clean Architecture Studio</span>
          </div>
          ...
          <p className="text-sm text-slate-400 max-w-md mx-auto leading-relaxed">
            A production-ready Todo management application built with decoupled domain logic, strict TypeScript safety, and Tailwind CSS.
          </p>
        </header>
