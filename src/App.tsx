      ...
      <div className="w-full max-w-3xl mx-auto relative z-10 flex flex-col gap-6">
        ...
        <header className="text-center space-y-3">
          ...
          <div className="flex items-center justify-center gap-3">
            <div className="w-10 h-11 rounded-xl bg-gradient-to-tr from-indigo-600 to-violet-500 flex items-center justify-center text-white shadow-lg shadow-indigo-500/30">
